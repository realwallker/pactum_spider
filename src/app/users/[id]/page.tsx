...
export default async function PublicProfilePage({
  ...
  const { data: userProfile } = await supabase
    .from("users")
    .select("id, nombre, bio, skills, intereses, ubicacion, foto, rol, created_at")
    .eq("id", id)
    .maybeSingle();
  ...
  // Get current user to check if they're looking at their own profile
  const {
  ...
  const joinedDate = new Date(userProfile.created_at).toLocaleDateString(
    "es-ES",
    {
      month: "long",
      year: "numeric",
